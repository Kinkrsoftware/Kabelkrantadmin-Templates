...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" x="0" y="0" width="1125" height="675pt" id="svg602" xml:space="preserve">
   <rect style="font-size:12;fill:#000000;fill-rule:evenodd;stroke-width:1;fill-opacity:1;" id="rect703" width="1125" height="843.75" x="0" y="0" />
   <xsl:if test="/article/photo != ''">
      <xsl:variable name="photo" select="/article/photo" />
      <image xlink:href="{$photo}" x="-30" y="0" width="1185" height="843.75" style="font-size:12;" id="image680" preserveAspectRatio="none" />
   </xsl:if>

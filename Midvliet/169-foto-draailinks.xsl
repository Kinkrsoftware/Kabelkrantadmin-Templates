...
<xsl:template match="/">
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" x="0" y="0" width="1500" height="675pt" id="svg602" xml:space="preserve">
   <rect style="font-size:12;fill:#000000;fill-rule:evenodd;stroke-width:1;fill-opacity:1;" id="rect703" width="1500" height="843.75" x="0" y="0" />
   <xsl:if test="/article/photo != ''">
      <xsl:variable name="photo" select="/article/photo" />
      <image xlink:href="{$photo}" x="-843.75" y="0" width="843.75" height="1500" id="image680" preserveAspectRatio="xMaxYMid meet" transform="matrix(0,-1,1,0,0,0)" />
   </xsl:if>
   <xsl:if test="/article/title != ''">
     <g id="g641">
       <rect style="font-size:12;fill:#ee8c1d;fill-opacity:0.7216;fill-rule:evenodd;" id="rect609" width="1500" height="65.7499771" x="0" y="711.25" />
